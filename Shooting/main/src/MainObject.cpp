...
MainObject::MainObject() {
    ...
    status_ = WALK_RIGHT;
    mute_ = false;
    input_type_.shoot_ = 0; // Khởi tạo trạng thái bắn
}
    ...
    if (events.type == SDL_KEYDOWN) {
        switch (events.key.keysym.sym) {
            ...
            case SDLK_u:
                ...
                break;
                case SDLK_SPACE: // Bắn
                input_type_.shoot_ = 1; // Đặt trạng thái giữ phím bắn
                ...
                if (!mute_) {
                    Mix_PlayChannel(-1, player_sound[8], 0);
                }
        ...
        switch (events.key.keysym.sym) {
            ...
            case SDLK_UP:
                ...
                break;
            case SDLK_SPACE:
                input_type_.shoot_ = 0; // Hủy trạng thái giữ phím bắn
                break;
        }
    }
}
...
void MainObject::UpdateImagePlayer(SDL_Renderer* des) {
    ...
    if (on_ground_) {
        if (status_ == WALK_LEFT) {
            LoadImg("img//goku_walk_left.png", des);
        } else {
            LoadImg("img//goku_walk_right.png", des);
        }
    } else {
        if (status_ == WALK_LEFT) {
